  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-24">
      <AnimatedSection>
            ...
            <Button
              ...
              render={
                <a 
                  ...
                  download 
                  title="Warning: may cause unsolicited hiring attempts"
                  onClick={() => showToast("Warning: may cause unsolicited hiring attempts")} 
                />
              }
            >
        ...
        <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-xl border border-border bg-muted/30">
